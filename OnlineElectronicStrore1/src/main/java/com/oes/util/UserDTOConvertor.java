...
public class UserDTOConvertor {
	...
	public static UserDefaultResponseDTO getOnlineOrderDefaultDTO(OnlineOrder onlineOrder) {
		UserDefaultResponseDTO dto = new UserDefaultResponseDTO(
				onlineOrder.getUsername(), 
				onlineOrder.getOnId(),
				onlineOrder.getProductName(),
                "OnlineOrder Added "+onlineOrder.getOrderDate()
                );
